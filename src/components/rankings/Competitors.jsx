export const CompetitorRankings = ({ competitorRankings, loadingCompetitors }) => {
      ...
      <tbody>
        {competitorRankings.map((item) => (
          ...
          >
            ...
            <td className="py-2 px-2">{`${item.competitor.user.name} ${item.competitor.user.lastName}`}</td>
